...
namespace KURSOVAYA
{
    ...
    "\nДата отправления: " + lbDataOt.Text + "\nДата прибытия: " + lbDataPrib.Text + $"\nСтоимость: "+ lbcost.Text;
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Автовокзал 'ДагестанПроБас'", new Font("Century Gothic", 12, FontStyle.Bold), Brushes.LightSeaGreen, new Point(70));
            e.Graphics.DrawString("ЧЕК ПОКУПКИ БИЛЕТА:", new Font("Century Gothic", 10, FontStyle.Bold), Brushes.Black, new Point(10, 25));
            e.Graphics.DrawString("Покупатель: " + Фио, new Font("Century Gothic", 10, FontStyle.Bold), Brushes.Black, new Point(10, 50));
            e.Graphics.DrawString("Номер билета: " + bilet_idtb.Text, new Font("Century Gothic", 10, FontStyle.Bold), Brushes.Black, new Point(10, 70));

            e.Graphics.DrawString("Номер автобуса: " + lbNomAvt.Text, new Font("Century Gothic", 10, FontStyle.Bold), Brushes.Black, new Point(10, 90));
            e.Graphics.DrawString("Номер места: " + bilet_NumMesta_tb.Text, new Font("Century Gothic", 10, FontStyle.Bold), Brushes.Black, new Point(10, 110));
            

            e.Graphics.DrawString("Дата отправления: " + lbDataOt.Text, new Font("Century Gothic", 10, FontStyle.Bold), Brushes.Black, new Point(10, 130));
            e.Graphics.DrawString("Дата прибытия: " + lbDataPrib.Text, new Font("Century Gothic", 10, FontStyle.Bold), Brushes.Black, new Point(10, 150));
            e.Graphics.DrawString("Место отправления: " + lbmest_ot.Text, new Font("Century Gothic", 10, FontStyle.Bold), Brushes.Black, new Point(10, 170));
            e.Graphics.DrawString("Место назначения: " + lbMestPrib.Text, new Font("Century Gothic", 10, FontStyle.Bold), Brushes.Black, new Point(10, 190));
            e.Graphics.DrawString("Стоимость: " + lbcost.Text + " руб.", new Font("Century Gothic", 12, FontStyle.Bold), Brushes.Black, new Point(10, 210));
